        ...
        <center>
            <form name="findID" method="post">
                ...
                <center>
                    ...
                    <input type = "button" style="WIDTH: 80pt; HEIGHT: 20pt" onclick="location.href='login.jsp'" value="뒤로가기">
                </center>
            </form>
        </center>
    </fieldset>
